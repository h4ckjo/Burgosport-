...
<div class="container-fluid bg-3 text-center">
	<div class="well" id="contenedor">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="camisetasoutdoor.php">Camisetas</a></li>
			<li><a href="pantalonesoutdoor.php">Pantalones</a></li>
			<li><a href="zapatillasoutdoor.php">Calzado</a></li>
	...
	<div class="row content">
			...
			<?php
			$sql="SELECT * FROM productos WHERE tipo='5' AND subtipo='4'";
